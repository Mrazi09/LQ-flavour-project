...
#################### Joao ####################
def Phi_s(wc_obj, par, meson):
    r"""CP violating angle phi_q"""
    M12, G12 = get_M12_G12(wc_obj, par, meson)
...
#################### Joao ####################
o = Observable('phi_s')
o.set_description(r"CP violating angle phi_q")
o.tex = r"$\phi_s$"
o.add_taxonomy(r'Process :: Meson-antimeson mixing ::  $\phi_s$ angle')
Prediction('phi_s', lambda wc_obj, par: Phi_s(wc_obj, par, 'Bs'))
#################### Joao ####################
